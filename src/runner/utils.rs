use std::{time::Duration, error::Error, io::{self, Write}};
...
use crate::{utils::random_line, config::structs::Config, network::{request::{VALUE_LENGTH, Request, RequestDefaults}, response::Response, utils::InjectionPlace}};
...
pub(super) fn create_client(proxy: &str, follow_redirects: bool, http: &str, timeout: usize) -> Result<Client, Box<dyn Error>> {
